...
ALTER TABLE Raza MODIFY id INT AUTO_INCREMENT;
ALTER TABLE Mascota MODIFY COLUMN id INT auto_increment;

ALTER TABLE TipoMascota MODIFY COLUMN id INT AUTO_INCREMENT;
